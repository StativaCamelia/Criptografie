...
def get_round_keys(C0, D0):
    ...
    #de cate ori se face shiftare (este dat)
...
if __name__ == '__main__':
    ...
    msg= 0b0000000100100011010001010110011110001001101010111100110111101111
    key = key_permutation(key, 64, PC1)
    print("Cheia permutata: "  + bin(key))
    ...
    msg_block = key_permutation(msg, 64, IP)
    L0 = msg_block >> 32
    R0 = msg_block & (2 ** 32 - 1)
